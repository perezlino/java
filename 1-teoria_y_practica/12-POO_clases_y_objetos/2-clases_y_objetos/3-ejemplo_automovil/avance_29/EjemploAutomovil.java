...
*/        
        ...
        // subaru.setRuedas(ruedasSubaru);  <================ Comentamos

        // ------------------------------------------------------------------------------------------------
        // Modificamos y movemos este codigo más abajo, porque estamos ocupando la instancia 'subaru' (Automovil subaru = new ...)
...
*/     
        ...
        //mazda.setRuedas(ruedasMazda);   <================ Comentamos

        // ------------------------------------------------------------------------------------------------
        // Modificamos y movemos este codigo más abajo, porque estamos ocupando la instancia 'subaru' (Automovil mazda = new ...) 
...
*/    
        ...
        // NO LO UTILIZAMOS EN ESTE EJEMPLO
        ...
        Automovil nissan = new Automovil("Nissan", "Navara", Color.GRIS, new Motor(4.0, TipoMotor.DIESEL), 
                            new Estanque(50)); // Eliminamos el constructor 'ruedasNissan'
                                              // y utilizamos en su caso un 'setConductor'
        nissan.setTipo(TipoAutomovil.PICKUP);
        nissan.setConductor(conductorNissan);  // <========= Agregamos 
        nissan.addRueda(new Rueda("Pirelli", 20, 11.5)); // <========= Agregamos
        nissan.addRueda(new Rueda("Pirelli", 20, 11.5)); // <========= Agregamos
        nissan.addRueda(new Rueda("Pirelli", 20, 11.5)); // <========= Agregamos
        nissan.addRueda(new Rueda("Pirelli", 20, 11.5)); // <========= Agregamos
        nissan.addRueda(new Rueda("Pirelli", 20, 11.5)); // <========= Agregamos
