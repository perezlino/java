...
/* 
        ...
        auto.modelo = Impreza
        auto.color = Blanco             <======= Ahora aparecen segun la modificacion que le dimos al 'enum'
        auto.patenteColor = Azul        <======= Ahora aparecen segun la modificacion que le dimos al 'enum'
        auto.cilindrada = 2.0
...
/* 
        ...
        auto.modelo = BT-50
        auto.color = Rojo               <======= Ahora aparecen segun la modificacion que le dimos al 'enum'                      
        auto.patenteColor = Azul        <======= Ahora aparecen segun la modificacion que le dimos al 'enum'
        auto.cilindrada = 3.0
...
/* 
        ...
        auto.modelo = Navara
        auto.color = Gris Oscuro        <======= Ahora aparecen segun la modificacion que le dimos al 'enum'
        auto.patenteColor = Azul        <======= Ahora aparecen segun la modificacion que le dimos al 'enum'
        auto.cilindrada = 3.5
