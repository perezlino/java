...
*/      
        // Creamos un objeto de iguales caracteristicas que el objeto 'nissan' y averiguaremos
        // si son "el mismo objeto (apuntan a la misma referencia)"
        Automovil nissan2 = new Automovil("Nissan", "Navara", "Gris oscuro", 3.5, 50); 

        // chequea si son el mismo objeto
        System.out.println("Son el mismo objeto?" + (nissan == nissan2)); // false

        // chequea si tienen el mismo valor ===> Previo a la modificacion de 'equals'
        System.out.println("Tienen el mismo valor?" + nissan.equals(nissan2)); // false

        // chequea si tienen el mismo valor ===> Con la modificacion de 'equals' realizada
