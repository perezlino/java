...
public class EjemploAutomovil {
    public static void main(String[] args) {
        ...
        // Al entregarle al segundo parametro un numero 'float' llamara al primer metodo 'calcularConsumo'
        System.out.println("Kilometros por litro: " + subaru.calcularConsumo(300, 0.6f));
        // Al entregarle al segundo parametro un numero 'integer' llamara al segundo metodo 'calcularConsumo'
