...
/* 
        auto.id = 1                   <================ Se agrego un 'id' correlativo a cada objeto de la clase 'Automovil'
...
/* 
        auto.id = 2                   <================ Se agrego un 'id' correlativo a cada objeto de la clase 'Automovil'
...
/* 
        auto.id = 3                   <================ Se agrego un 'id' correlativo a cada objeto de la clase 'Automovil'
