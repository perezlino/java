...
public class Automovil {
    ...
    //--------------------------------------------------------------------------------------------------------
    // Modificamos para que de esta forma se puedan llamar a los metodos de manera encadenada
    public Automovil addRueda(Rueda rueda){ // Cambiamos 'void' por 'Automovil'
        if(indiceRuedas < this.ruedas.length) {
            this.ruedas[indiceRuedas++] = rueda;
        }
        return this; // <============= Agregamos
    }
    //--------------------------------------------------------------------------------------------------------          
