/*  ======================================================
    ...
    Obtener el nombre más largo de tres personas, según los siguientes requerimientos
        ...
        -	Mediante el teclado pedir el nombre completo (nombre + apellido) de tres miembros de la 
            familia o amigos usando la clase JOptionPane y método showInputDialog().

        -	Calcular e Imprimir el nombre de la persona que tenga el nombre más largo (en cantidad de 
            caracteres)(Imprimir sólo uno de los tres, el de más caracteres en el nombre.)
